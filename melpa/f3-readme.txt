...
The Fantastic File Finder for emacs. Find files fast, using helm. It's cool,
trust me.
...
This package provides an interactive interface to the 'find' utility
using helm as a frontend to solve both of these problems quickly so you
can get back to work and stop playing around with the command line.
...
current text pattern among all open buffers, and also spawn a 'find'
...
The current "input mode" determines whether 'find' searches using
wildcards or regex; see keybindings below.
