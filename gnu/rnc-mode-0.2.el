...
;; 2017-06-28  Ivan Andrus	 <darthandrus@gmail.com>
;; 
;; 	Fix indentation in rnc-mode
;; 
;; 	* rnc-mode.el (rnc-smie-forward-token,rnc-smie-backward-token): Only
;; 	move one character for a punctuation token.
;; 
;; 2016-04-27  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
;; 	* packages/rnc-mode/rnc-mode.el (rnc-smie-rules): Add empty-line-token
;; 	rule.
;; 
