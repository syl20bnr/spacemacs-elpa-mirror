...
(autothemer-deftheme
 ...
 ((default                                   (:foreground creamsody-foreground0 :background creamsody-background0))
  ...
  (defface creamsody-modeline-one-active '((t
  ...
  (defface creamsody-modeline-one-inactive '((t
  ...
  (defface creamsody-modeline-two-active '((t
   (:foreground ,creamsody-bright_green
                :background ,creamsody-muted_blue
                :height 120
                :inverse-video nil
  ...
  (defface creamsody-modeline-two-inactive '((t
   (:foreground ,creamsody-faded_green
                :background ,creamsody-background_cyan
                :height 120
                :inverse-video nil
  ...
  (defface creamsody-modeline-three-active '((t
  ...
  (defface creamsody-modeline-three-inactive '((t
  ...
  (defface creamsody-modeline-four-active '((t
  ...
  (defface creamsody-modeline-four-inactive '((t
